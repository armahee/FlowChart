...
var stepFinder = [
	...
	['flow_chart_three','arrow_dwn1','upper_arrow_f','upper_arrow','bank_arrow_2','StraitLine','r_bb4_4','r_bb5','r_bb1','alu_arrow'],
	['flow_chart_three','arrow_dwn1','upper_arrow_f','upper_arrow','bank_arrow_2','StraitLine','r_bb4_4','r_bb5','r_bb1','alu_arrow','r_bb6','lower_arrow1'],
	['flow_chart_three','arrow_dwn1','upper_arrow_f','upper_arrow','bank_arrow_2','StraitLine','r_bb4_4','r_bb5','r_bb1','alu_arrow','r_bb6','lower_arrow1'],
	['flow_chart_three','arrow_dwn1','upper_arrow_f','upper_arrow','bank_arrow_2','StraitLine','r_bb4_4','r_bb5','r_bb1','alu_arrow','r_bb6','lower_arrow1'],
	['flow_chart_three','arrow_dwn1','upper_arrow_f','upper_arrow','bank_arrow_2','StraitLine','r_bb4_4','r_bb5','r_bb1','alu_arrow','r_bb6','lower_arrow1']
];
...
function back_10(i) {
	if(menuNum < 4){
		...
		function frame7() {
			if(pos8 == epos8){
				elem8.classList.add('hide');
				elem8_1.classList.add('hide');
				elem8.style.top = '172px';
				if(stepNum > i){
					elem8.classList.remove('hide');
					elem8_1.classList.remove('hide');
				}
